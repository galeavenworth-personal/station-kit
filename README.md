...
- Handoff schema: [`docs/SCHEMAS.md`](docs/SCHEMAS.md:47)
- Handoff template: [`templates/.kilocode/contracts/handoff/handoff_packet.md`](templates/.kilocode/contracts/handoff/handoff_packet.md:1)

2) **Explicit task state (work orders)**
- Task identity/state lives outside chat history via Beads.
- Operator contract: [`templates/AGENTS.md`](templates/AGENTS.md:1)
...
- Ledger schema: [`docs/SCHEMAS.md`](docs/SCHEMAS.md:87)
- Workflow: [`templates/.kilocode/workflows/orchestrate-respond-to-pr-review.md`](templates/.kilocode/workflows/orchestrate-respond-to-pr-review.md:14)

## Reviewer path (recommended)
1) What SK depends on and why: [`docs/WHY_KILO_CODE.md`](docs/WHY_KILO_CODE.md:1)
2) How to pick models per station safely: [`docs/MODEL_STRATEGY.md`](docs/MODEL_STRATEGY.md:1)
3) The end-to-end toy run: [`docs/DEMO_WALKTHROUGH.md`](docs/DEMO_WALKTHROUGH.md:1)
4) Workflow inventory: [`docs/WORKFLOW_REFERENCE.md`](docs/WORKFLOW_REFERENCE.md:1)
5) The schema contracts: [`docs/SCHEMAS.md`](docs/SCHEMAS.md:1)
6) Positioning matrix: [`docs/COMPARISON_MATRIX.md`](docs/COMPARISON_MATRIX.md:1)
