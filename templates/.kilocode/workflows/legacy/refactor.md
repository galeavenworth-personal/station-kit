---
description: Legacy (monolithic) refactor workflow reference.
auto_execution_mode: 0
---

# Legacy: Refactor Workflow (Monolithic)
...
- If your project does not support refactor automation, treat this as a documentation reference, not an executable workflow.
